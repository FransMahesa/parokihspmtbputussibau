...
<link rel="stylesheet" type="text/css" href="styles/services_responsive.css">
	<title>Daftar Galeri HSPMTB Pts</title>
<style type="text/css">
...
img:hover { transform: scale(1.5); }
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="img/gambar/gereja.jpg" data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title"><span>HSPMTB</span> GALERI</div>
