				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="top_bar_item"><a href="contanct.php">Jl. A Yani No 34 Putussibau Kota, Kapuas Hulu, Kalimantan Barat</a></div>
							<!-- <div class="top_bar_item"><a href="#">Jl. A Yani No 34 Putussibau Kota, Kapuas Hulu, Kalimantan Barat</a></div> -->
							<div class="emergencies  d-flex flex-row align-items-center justify-content-start ml-auto">Telp. : +62821 - 5855 - 8004</div>
						</div>
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class="main_nav ml-auto">
								<ul>
									...
									<!--<li><a href="janji_iman.php">EVENT</a></li>-->
						...
						<div class="logo_container">
							<a href="index.php">
								<div class="logo_content d-flex flex-column align-items-start justify-content-center">
									...
									<div class="logo_sub">Jl.A. Yani No. 34</div>
								</div>
							</a>
						</div>
					</div>
	...
	<div class="menu_container menu_mm">
		...
		<div class="menu_inner menu_mm">
			...
			<div class="menu_extra">
				<div class="menu_appointment"><a href="#">SEKRETARIAT PAROKI</a></div>
				<div class="menu_emergencies">HUB : (+62) 821-5855-8004</div>
			</div>
